...
{
    const json_table_t table[] = {
        { "MOCK:ENABLE", String(g.mock_enable) },
        { "MOCK:HOME_LAT", String(g.mock_home_lat, 6) },
        { "MOCK:HOME_LON", String(g.mock_home_lon, 6) },
        { "MOCK:GHOSTS", String(g.mock_ghost_count) },
        { "MOCK:RADIUS", String(g.mock_ring_radius, 1) },
        { "MOCK:SPEED", String(g.mock_speed, 1) },
        { "MOCK:UAS_TYPE", String(g.ua_type) },
        { "MOCK:UAS_ID", String(g.uas_id) },
        { "MOCK:SELF_ID", String(g.mock_self_id) },
        { "MOCK:OPERATOR_ID", String(g.mock_operator_id) },
