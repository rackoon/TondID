...
const Parameters::Param Parameters::params[] = {
    ...
    { "QA_ENABLE",         Parameters::ParamType::UINT8,  (const void*)&g.qa_mode_enabled, 0, 0, 1 },
    { "QA_UAS_SEED",       Parameters::ParamType::CHAR20, (const void*)&g.qa_uas_id_seed[0], 0, 0, 0 },
    { "QA_HOME_LAT",       Parameters::ParamType::FLOAT,  (const void*)&g.qa_home_lat, 59.4370f, -90, 90 },
    { "QA_HOME_LON",       Parameters::ParamType::FLOAT,  (const void*)&g.qa_home_lon, 24.7536f, -180, 180 },
    { "QA_ALT_M",          Parameters::ParamType::FLOAT,  (const void*)&g.qa_alt_m, 65.0f, -1000.0f, 10000.0f },
    { "QA_RADIUS",         Parameters::ParamType::FLOAT,  (const void*)&g.qa_radius_m, 120.0f, 1.0f, 5000.0f },
    { "QA_SPEED",          Parameters::ParamType::FLOAT,  (const void*)&g.qa_speed_mps, 6.0f, 0.1f, 100.0f },
    { "QA_HEADING",        Parameters::ParamType::UINT8,  (const void*)&g.qa_heading_mode, 0, 0, 2 },
    { "QA_SLOTS",          Parameters::ParamType::UINT8,  (const void*)&g.qa_slot_count, 1, 1, MOCK_SLOT_COUNT },
    { "QA_LABEL",          Parameters::ParamType::CHAR20, (const void*)&g.qa_lab_label[0], 0, 0, 0 },
    { "QA_LAA_MAC",        Parameters::ParamType::CHAR20, (const void*)&g.qa_lab_mac_override[0], 0, 0, 0 },
